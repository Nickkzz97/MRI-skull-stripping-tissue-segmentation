...
class FindEllipseRHT(object):
    ...
    def __init__(self, iters=1000, debug_mode=False, plot_mode=False):
        ...
        self.major_bound = [60, 320]  # major axis
        self.minor_bound = [60, 320]  # minor axis
    ...
    def run(self, edge, mask):
        ...
        return p, q, major, minor, best[-2], best[-1]
    ...
    def find_center(self, pt, plot_mode=False):
        ...
        for i, j in zip([0, 1], [1, 2]):
            ...
            # bisector
            slope = (m1[1] - t12[1]) / ((m1[0] - t12[0]) + 1e-12)
            intercept = (m1[0]*t12[1] - t12[0]*m1[1]) / ((m1[0] - t12[0]) + 1e-12)
